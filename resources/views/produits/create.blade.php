    ...
    <x-categories-card>
        ...
        <form action="{{ route('produits.store') }}" method="post">
            ...
            <div>
                ...
                <x-text-input  id="reference" class="block mt-1 w-full" type="text" name="reference" :value="old('reference')" required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-textarea class="block mt-1 w-full" id="libelle" name="libelle">{{ old('libelle') }}</x-textarea>
